...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Last 7 days | 48 | 27.1% | 374 | 3,392 | 48 | 23.7 |
| Last 30 days | 48 | 27.1% | 374 | 3,392 | 48 | 23.7 |
| Last year | 48 | 27.1% | 374 | 3,392 | 48 | 23.7 |
| All time | 48 | 27.1% | 374 | 3,392 | 48 | 23.7 |
...
| messages per session | 172 | 541 | 1,598 | 1,598 | 7,615 |
...
| `write` | 29 | 0 | 0 | 0% |
| `github__get_issue` | 25 | 0 | 0 | 0% |
| `filesystem__read_file` | 23 | 0 | 0 | 0% |
| `github__get_pr` | 21 | 1 | 0 | 4.8% |
...
| `github__get_check_runs` | 10 | 1 | 0 | 10% |
| `github__get_branch` | 9 | 0 | 0 | 0% |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| tokens per run | 26,602 | 365,748 | 9,000,677 | 39,737,697 | 179,731,553 |
| messages per session | 10 | 112 | 601 | 1,598 | 20,414 |
...
| `github__get_check_runs` | 63 | 7 | 0 | 11.1% |
...
| `github__get_branch` | 37 | 13 | 0 | 35.1% |
| `github__get_pr_reviews` | 36 | 2 | 0 | 5.6% |
| `github__list_prs` | 36 | 1 | 0 | 2.8% |
