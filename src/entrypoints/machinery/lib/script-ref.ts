/**
 * script-ref.ts — Gives each one-shot script in `src/entrypoints/machinery/` a
 ...
 *
 * `build-dist.ts` bundles each script in `src/entrypoints/machinery/` separately, and a bundled
